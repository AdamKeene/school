...
![M2Lab2](resources/M2Lab2.png)

```r
plot(lstat , medv , col = "red")
```

![M2Lab3](resources/M2Lab3.png)

```r
plot(lstat , medv , pch = 20)
```

![M2Lab4](resources/M2Lab4.png)

```r
plot(lstat , medv , pch = "+")
```

![M2Lab5](resources/M2Lab5.png)

```r
plot (1:20 , 1:20, pch = 1:20)  
```

![M2Lab6](resources/M2Lab6.png)
...
![M2Lab7](resources/M2Lab7.png)

```r
plot(hatvalues(lm.fit))
```

![M2Lab8](resources/M2Lab8.png)
