 ...
 * one event and generate one output event. Now adapted for RMI with remote database calls.
 */
@SuppressWarnings("deprecation")
abstract public class CommandEventHandler implements Observer {

    /**
     * Reference to the remote database object.
     */
    protected DBInterface objDataBase;
     ...
     */
    public CommandEventHandler(DBInterface objDataBase, int iCommandEvCode, int iOutputEvCode) {
