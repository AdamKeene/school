...
public class ListCoursesRegisteredHandler extends CommandEventHandler {
     ...
     */
    public ListCoursesRegisteredHandler(DBInterface objDataBase, int iCommandEvCode, int iOutputEvCode) {
    ...
    protected String execute(String param) {
        try {
            ...
            return "Error retrieving student information: " + e.getMessage();
        }
    }
}
