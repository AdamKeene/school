...
public class RegisterStudentHandler extends CommandEventHandler {
     ...
     */
    public RegisterStudentHandler(DBInterface objDataBase, int iCommandEvCode, int iOutputEvCode) {
    ...
    protected String execute(String param) {
        try {
            ...
            // check if course is overbooked after registration
            EventBus.announce(EventBus.EV_OVERBOOKED, sSID + " " + sCID + " " + sSection);
            return "Successful!";
