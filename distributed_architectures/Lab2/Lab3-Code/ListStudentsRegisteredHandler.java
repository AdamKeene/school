...
public class ListStudentsRegisteredHandler extends CommandEventHandler {
     ...
     */
    public ListStudentsRegisteredHandler(DBInterface objDataBase, int iCommandEvCode, int iOutputEvCode) {
    ...
    protected String execute(String param) {
        try {
            ...
            return "Error retrieving course information: " + e.getMessage();
        }
    }
}
